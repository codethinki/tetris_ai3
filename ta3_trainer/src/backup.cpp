...
void backup(std::filesystem::path const& base, size_t max_backups) {
    ...
    auto files = std::filesystem::directory_iterator{backupDir}
        ...
        | std::views::transform([&baseStr](auto& entry) {
